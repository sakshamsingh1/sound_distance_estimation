# metu data balancing
# 1. augment all the data : both mic and meta
...
# constants
read_base_dir = '/vast/sk8974/experiments/dsynth/data/input/gen_dcase_stars_loc_metu_marco/'
read_meta_dir = os.path.join(read_base_dir, 'metadata_dev/marco')
read_mic_dir = os.path.join(read_base_dir, 'mic_dev/marco')

write_base_dir = '/vast/sk8974/experiments/dsynth/data/input/gen_dcase_stars_Aloc_Ametu_Amarco'
write_meta_dir = os.path.join(write_base_dir, 'metadata_dev', 'aug_marco')
write_mic_dir = os.path.join(write_base_dir, 'mic_dev', 'aug_marco')
