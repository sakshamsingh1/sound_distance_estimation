...
# gt_dir = '/vast/sk8974/experiments/dsynth/data/processed/dist_base_loc/mic_dev_label'
gt_dir = '/vast/sk8974/experiments/dsynth/data/processed/dist_d_s_basel_Am_Am/mic_dev_label'

curr_param = '713_1_dev_split0_accdoa_mic_gcc_20230428025006_test'
pred_dir = f'/vast/irr2020/dist_est_saksham/results/{curr_param}'
