...
# constants
read_base_dir = '/vast/sk8974/experiments/dsynth/data/util_data/base_loc'
read_meta_dir = os.path.join(read_base_dir, 'metadata_dev/locata')
read_mic_dir = os.path.join(read_base_dir, 'mic_dev/locata')

write_base_dir = '/vast/sk8974/experiments/dsynth/data/input/gen_dcase_stars_AFixbaseloc_Ametu_Amarco'
write_meta_dir = os.path.join(write_base_dir, 'metadata_dev', 'aug_locata')
write_mic_dir = os.path.join(write_base_dir, 'mic_dev', 'aug_locata')
