...
read_meta_dir = os.path.join(read_base_dir, 'metadata_dev/metu')
read_mic_dir = os.path.join(read_base_dir, 'mic_dev/metu')

write_base_dir = '/vast/sk8974/experiments/dsynth/data/util_data/bal_and_aug_metu/aug_metu'
